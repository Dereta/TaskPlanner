		...
		public void actionPerformed(ActionEvent e)
		{
			...
			if (e.getSource().equals(btnSave))
			{
				...
				if (tfTitle.getText().equalsIgnoreCase("Title") && tfTitle.getForeground() == Color.LIGHT_GRAY ||
						tfDueDate.getText().equalsIgnoreCase("dd.mm.yyyy") && tfDueDate.getForeground() == Color.LIGHT_GRAY || 
						taContent.getText().equalsIgnoreCase("Content") && taContent.getForeground() == Color.LIGHT_GRAY)
				{
				...
				if (correctDate == null)
				{
					JOptionPane.showMessageDialog(null, "Erroneous date format.\nPlease check the date.\ne.g. dd.mm.yyyy > 19.02.2019", "Error",
							JOptionPane.ERROR_MESSAGE);
				...
				{
					String options[] = {"Save", "Abort"};
					int selection = JOptionPane.showOptionDialog(null, "Do you want to set status to 'done'?\nThe Task will no longer be visible!", "Update Task", 0, JOptionPane.WARNING_MESSAGE, null, options, null);
					if (selection == 1)
					{
